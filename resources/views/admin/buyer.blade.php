                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>{{$item->email}}</td>
                                                    <td>{{$item->address}}</td>
                                                    <td style="text-align:center;"> <img height="80px;" width="80px;"  src="{{ file_exists(@$item->image) ? asset(@$item->image) : asset('backend/uploads/staff/customer.png') }}" class="img img-fluid">  </td>
                                                    <td> 
